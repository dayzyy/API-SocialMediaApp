...
from .views import delete_comment, delete_post, get_post, register, get_user, get_profile_by_email, get_profile_by_id, follow, unfollow, make_post, like_post, unlike_post, make_comment, update_profile_picture
...
urlpatterns = [
    ...
    path('update/picture/', update_profile_picture, name='update-profile-picture')
]
